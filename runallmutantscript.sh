...
do
	...
	do
		...
		do
			...
			versions.alt/versions.orig/v$j/schedule.exe random1 random2 random3 < $input_file > outputs/mutant/v$j/TS$i/"t"$nama
...
do
	...
	do
		...
		source.alt/source.orig/schedule.exe random1 random2 random3 < $input_file > outputs/ori/TS$i/"t"$nama
